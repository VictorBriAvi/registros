          ...
          <ul className="list-group text-center">
            <li className="list-group-item d-flex justify-content-between align-items-start">
              <div className="ms-2 me-auto">
                ...
                <div className="text-center">{productoById.codigoProducto}</div>
              </div>
            </li>
            <li className="list-group-item d-flex justify-content-between align-items-start">
              <div className="ms-2 me-auto">
                <div className="fw-bold">Nombre del Producto</div>
                <div className="text-center">{productoById.nombreProducto}</div>
              </div>
            </li>
            <li className="list-group-item d-flex justify-content-between align-items-start">
              <div className="ms-2 me-auto">
            ...
            <li className="list-group-item d-flex justify-content-between align-items-start">
              <div className="ms-2 me-auto">
                ...
                <div className="text-center">{productoById.precioProducto}</div>
              </div>
            </li>
          </ul>
        </div>
